...
async function alerts(){
  ...
  $("#testWorkflowText").onclick=()=>runChemicalDingTest("workflow_text","#testWorkflowText","Test Workflow Text");
  $("#testRobotJson").onclick=()=>runChemicalDingTest("robot_json","#testRobotJson","Test Robot JSON");
